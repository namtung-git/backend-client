...
if __name__ == "__main__":
    ...
    logger = wirepas_gateway_client.tools.setup_log('adv_test_history',
                                                    fluentd_tag='python',
